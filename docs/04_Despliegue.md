# Reproducción — Despliegue y operación
...
| API base | `/api/reproducciones` |

## Docker

```bash
docker build -t duoc/caso03-reproduccion:1.0.0 .
docker run -p 8080:8080 duoc/caso03-reproduccion:1.0.0
```
